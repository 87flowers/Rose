...
namespace rose {
  ...
  private:
    ...
    template <typename Controls> auto searchRoot(const Controls &ctrl, Line &pv, i32 depth) -> i32;
    template <typename Controls> auto search(const Controls &ctrl, Line &pv, i32 alpha, i32 beta, i32 ply, i32 depth) -> i32;
  };
