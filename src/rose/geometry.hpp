...
namespace rose::geometry {
  ...
  inline auto slider_broadcast(u8x64 x) -> u8x64 {
    ...
    u8x64 expand {{
      ...
      0x80, 0x28, 0x28, 0x28, 0x28, 0x28, 0x28, 0x28,  //
      0x80, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,  //
      0x80, 0x38, 0x38, 0x38, 0x38, 0x38, 0x38, 0x38,  //
    }};
    return expand.swizzle(u8x64 {_mm512_sad_epu8(x.raw, _mm512_setzero_si512())});
#elif LPS_AVX2
    u8x32 expand {{
      0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  //
      0x80, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08,  //
